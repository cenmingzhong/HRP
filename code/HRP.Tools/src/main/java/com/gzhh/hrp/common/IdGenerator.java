 ...
 * IdGenerator的优点是，整体上按照时间自增排序，并且整个分布式系统内不会产生ID碰撞(由数据中心ID和机器ID作区分)，并且效率较高，经测试，SnowFlake每秒能够产生26万ID左右。
 */
public class IdGenerator {
 ...
 // ==============================Fields===========================================
    ...
    private static IdGenerator instance = new IdGenerator(3);
    ...
    {
        String newId = String.valueOf(instance.nextId());
        if(newId.length()<15){
            newId = StringTools.padLeft(newId, 15, '0');
        }
        return newId;
    }
...
//                    System.out.println("重复："+ids.get(i));
//                }
//            }
//            
//        }
