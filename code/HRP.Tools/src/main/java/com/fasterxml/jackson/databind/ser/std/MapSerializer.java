        ...
        throws IOException
    {
        ...
        for (Map.Entry<?,?> entry : value.entrySet()) {
            ...
            if (keyElem == null) {
                ...
                if(keyElem.getClass() == String.class){
                    if(value.getClass().isAssignableFrom(Hashtable.class)){
                        keySerializer.serialize(keyElem.toString(), gen, provider);
                    }else{
                        keySerializer.serialize(StringTools.capFirstLetter(keyElem.toString()), gen, provider);
                    }
                }else{
