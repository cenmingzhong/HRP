...
//amend by Jerry 17May2014
//p.panel("panel").animate(_395.expand,0,function(){
p.panel("panel").animate(_395.expand,0,function(){
_363(_391);
});
}
...
if(getDataFromJson(rows[i],opts.idField)==row){
return i;
}
}
return -1;
...
if(col){
var _6e6=getDataFromJson(_6e3,_6e5);//_6e3[_6e5];
