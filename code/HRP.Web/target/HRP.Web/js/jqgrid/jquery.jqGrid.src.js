...
$.fn.jqGrid = function( pin ) {
    ...
    return this.each( function() {
        ...
        setPager = function (pgid, tp){
            ...
            var sep = "<td class='' style='width:1px;'><span class='ui-separator'></span></td>",
            pginp = "",
            ...
            $("#"+$.jgrid.jqID(pgid) )
            .append("<div id='"+pgcnt+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+cent+"' align='left' style='white-space:pre;'></td><td id='"+rgt+"' align='right'></td></tr></tbody></table></div>")
        ...
        var setFitHeight = function(){
            ...
            $("#gbox_"+self.id+" .ui-jqgrid-bdiv").height(totalHeight-pageHeight-headHeight-1)
            $("#"+self.id).setGridWidth($("#gbox_"+self.id).parent().width());
        }
        $("#gbox_"+self.id).parent().resize(function(){   
        	$("#dataBlock").setGridWidth(0);
        	$("#dataBlock").setGridHeight(0);
